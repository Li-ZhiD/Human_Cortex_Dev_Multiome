...
annot = pd.read_csv('./NIH4392BA17_annotation.csv',
                   sep=',', index_col=0)
...
ncem.data.variance_decomposition(var_decomp, figsize=(5,3), save='./NIH4392BA17_r65')
...
type_coupling = ncem.type_coupling_analysis_circular(edge_attr='magnitude', 
                                                     ...
                                                     text_space=1.28,
                                                    save='./NIH4392BA17_r65_magnitude')

type_coupling.to_csv("./NIH4392BA17_r65_magnitude_all.csv", sep=',', index=None)
type_coupling[(type_coupling['de_genes_abs'] > 25) & (type_coupling['magnitude'] > 1)].to_csv('./NIH4392BA17_r65_magnitude.csv', sep=',', index=None)
