...
annot = pd.read_csv('./NIH5900BA17_annotation.csv',
                   sep=',', index_col=0)
...
ncem.data.variance_decomposition(var_decomp, figsize=(5,3), save='./NIH5900BA17_r35')
...
type_coupling = ncem.type_coupling_analysis_circular(edge_attr='magnitude', 
                                                     ...
                                                     text_space=1.28,
                                                    save='./NIH5900BA17_r35_magnitude')

type_coupling.to_csv("./NIH5900BA17_r35_magnitude_all.csv", sep=',', index=None)
type_coupling[(type_coupling['de_genes_abs'] > 25) & (type_coupling['magnitude'] > 1)].to_csv('./NIH5900BA17_r35_magnitude.csv', sep=',', index=None)
