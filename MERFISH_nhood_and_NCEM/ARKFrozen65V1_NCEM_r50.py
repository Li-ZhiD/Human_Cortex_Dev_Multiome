...
ad = sq.read.vizgen(path='./',
    counts_file="./subset_cell_by_gene.csv",
    meta_file="./subset_cell_metadata.csv")

annot = pd.read_csv('./ARKFrozen65V1_annotation.csv',
                   sep=',', index_col=0)
...
ncem.data.variance_decomposition(var_decomp, figsize=(5,3), save='./ARKFrozen65V1_60k_r50')
...
type_coupling = ncem.type_coupling_analysis_circular(edge_attr='magnitude', 
                                                     ...
                                                     text_space=1.28,
                                                    save='./ARKFrozen65V1_60k_r50_magnitude')

type_coupling.to_csv("./ARKFrozen65V1_60k_r50_magnitude_all.csv", sep=',', index=False)

type_coupling[(type_coupling['de_genes_abs'] > 25) & (type_coupling['magnitude'] > 1)].to_csv('./ARKFrozen65V1_60k_r50_magnitude.csv', sep=',', index=None)
...
type_coupling = ncem.type_coupling_analysis_circular(edge_attr='de_genes', 
                                                     ...
                                                     de_genes_threshold=25,
                                                     text_space=1.28,
                                                     save='./ARKFrozen65V1_60l_r50_DEG')
